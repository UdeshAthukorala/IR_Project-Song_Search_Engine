...
def search(search_query):
    ...
    search_fields = []
    sort_num = 0
    field_list = ["english_artist","sinhala_artist", "english_lyrics","sinhala_lyrics","english_music","sinhala_music" ]
    all_fields = ["title","song_lyrics","english_genre", "sinhala_genre", "english_artist", "sinhala_artist", "english_lyricist", "sinhala_lyrics", "english_music","sinhala_music"]
    final_fields = []
